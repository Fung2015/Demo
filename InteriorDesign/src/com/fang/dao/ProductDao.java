...
public class ProductDao {
	...
	public void addOrders(Order order) throws SQLException {
		...
		runner.update(conn,sql, order.getOid(),order.getOrdertime(),order.getTotal(),order.getState(),
				order.getAddress(),order.getName(),order.getTelephone(),order.getUser().getUid(),order.getRemark());
	}
	...
	public void updateOrderAdrr(Order order) throws SQLException {
		...
		String sql = "update orders set address=?,name=?,telephone=?,remark=? where oid=?";
		runner.update(sql, order.getAddress(),order.getName(),order.getTelephone(),order.getRemark(),order.getOid());
	}
