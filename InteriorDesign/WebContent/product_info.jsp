			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						首付: <strong style="color: #ef0101;">￥：${product.shop_price}/间</strong> 市 场 价：
						<del>￥${product.market_price}/间</del>
					</div>

					<div style="margin: 10px 0 10px 0;">
						实际价格: <a target="_blank" title="根据项目大小，适当调整价格"
							style="background-color: #f07373;">面议</a>
					</div>
			...
			<div style="width: 950px; margin: 0 auto;">
				...
				<div style="background-color: #d3d3d3; width: 900px;">
					<table class="table table-bordered">
						<tbody>
							<tr class="active">
								<th><strong>作品评论</strong></th>
							</tr>
							<tr class="warning">
								<th>暂无作品评论信息 <a>[发表评论]</a></th>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div style="background-color: #d3d3d3; width: 900px;">
					<table class="table table-bordered">
						<tbody>
							<tr class="active">
								<th><strong>作品咨询</strong></th>
							</tr>
							<tr class="warning">
								<th>暂无作品咨询信息 <a>[发表咨询]</a></th>
							</tr>
						</tbody>
					</table>
				</div>
