...
<HTML>
			...
			function findOrderInfoByOid(oid){
				...
				$.post(
					...
					function(data){
						...
						//{"shop_price","count","pname"","pimage","subtotal"
						var content = "<tr id='showTableTitle'><th width='20%'>图片</th><th width='25%'>作品</th><th width='20%'>定金</th><th width='15%'>数量</th><th width='20%'>小计</th></tr>";
	...
	<body>
        ...
        <div id="showDiv" class="blk" style="display:none;">
            <div class="main">
                <h2>项目编号：<span id="shodDivOid" style="font-size: 13px;color: #999">123456789</span></h2>
                <a href="javascript:void(0);" id="closeBtn" class="closeBtn">关闭</a>
                <div id="loading" style="padding-top:30px;text-align: center;">
                	<img alt="" style="width:100px;height:100px;" src="${pageContext.request.contextPath }/images/loading3.gif">
                </div>
