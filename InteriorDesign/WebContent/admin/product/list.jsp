...
<body>
	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>作品列表</strong>
					</TD>
				</tr>
				<tr>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="17%">作品图片</td>
								<td align="center" width="17%">作品名称</td>
								<td align="center" width="17%">作品定金</td>
