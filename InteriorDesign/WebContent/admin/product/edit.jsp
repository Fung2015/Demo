...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			$(function(){
				//获得当前回显的product的category
				$("#cid option[value='${product.category }']").prop("selected",true);
				//是否热门
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProductList" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<button type="submit" id="userAction_save_do_submit" value="确定" class="button_ok" onclick="history.go(-1)">
							&#30830;&#23450;
						</button>
