...
<html>
	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				<div class="col-md-12">
					<h2>热门作品&nbsp;&nbsp;<img src="img/title2.jpg"/></h2>
				</div>
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/1.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="#">
							<img src="products/2.jpg" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
			...
			<!-- 广告条 -->
            <div class="container-fluid">
				<img src="products/3.jpg" width="100%"/>
			</div>
			
			<!-- 最新设计 -->
			<div class="container-fluid">
				<div class="col-md-12">
					<h2>最新设计&nbsp;&nbsp;<img src="img/title2.jpg"/></h2>
				</div>
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/4.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="#">
							<img src="products/5.jpg" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
