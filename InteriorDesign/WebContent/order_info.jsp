	...
	<div class="container">
		<div class="row">
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						<tr class="warning">
							<th colspan="5">项目编号:${order.oid }</th>
						</tr>
						<tr class="warning">
							<th>图片</th>
							<th>作品</th>
			...
			<div style="text-align: right; margin-right: 120px;">
				项目定金: <strong style="color: #ff6600;">￥${order.total }元</strong>
			</div>
		...
		<div>
			...
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/product" method="post"
				...
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-1 control-label">联系人</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="inputPassword3" name="name"
							placeholder="请输入联系人" value="${user.name }">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="confirmpwd" class="col-sm-1 control-label">备注</label>
					<div class="col-sm-5">
