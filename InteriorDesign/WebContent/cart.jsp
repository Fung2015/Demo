	...
	<body>
			...
			<div class="container">
				<div class="row">
					...
					<div style="margin:0 auto; margin-top:10px;width:950px;">
						<strong style="font-size:16px;margin:5px 0;">项目详情</strong>
				...
				<div style="margin-right:130px;">
					...
					具体项目价格面议&nbsp;&nbsp;
				</em> 赠送积分: <em style="color:#ff6600;">${cart.total }</em>&nbsp; 作品定金: <strong style="color:#ff6600;">￥${cart.total }元</strong>
					</div>
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						<a href="javascript:;" onclick="clearCart()" id="clear" class="clear">清空选择</a>
						<a href="${pageContext.request.contextPath }/product?method=submitOrder">
							<input type="button" width="100" value="提交项目" name="submit" border="0" style="background: url('./images/register.gif') no-repeat scroll 0 0 rgba(0, 0, 0, 0);
		...
		<c:if test="${empty cart.cartItems }">
			<div style="text-align:center">
				<img alt="" src="${pageContext.request.contextPath }/images/cartempty.jpg">
				<a href="${pageContext.request.contextPath }">您还没有选择任何作品，返回首页</a>
			</div>
		</c:if>
